...
*Thuộc series dự án **Mini Bank** — xây dựng backend ngân hàng số bằng Spring Boot làm project demo cho CV/phỏng vấn. Đây là Phase 2/6, tiếp nối Phase 1 (Core Banking & Auth).*
